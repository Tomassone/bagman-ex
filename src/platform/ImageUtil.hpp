...
public:
  ...
  // static SDL_Surface *make_bicolor(const SDL_Surface *image, int background,
  // int new_foreground, bool alpha);
  static void replace_color_in_place(SDL_Surface *image, int old_color,
                                     int new_color);
  static SDL_Surface *replace_color(const SDL_Surface *src, int old_color,
                                    int new_color, bool alpha);
  ...
  static void render_half_size(const SDL_Surface *source, SDL_Surface *dest,
                               int src_x_offset, int src_y_offset,
                               int dest_x_offset, int dest_y_offset);
  static void rotate_90(const SDL_Surface *input, SDL_Surface *output,
                        bool positive);
  ...
  /*
      static inline void set_pixel_slow( SDL_Surface* pSurface , int x , int y ,
     SDL_Color color )
      {
          //convert color
          Uint32 col = SDL_MapRGB ( pSurface->format , color.r , color.g ,
     color.b ) ;
